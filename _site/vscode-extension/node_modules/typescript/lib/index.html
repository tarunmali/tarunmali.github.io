...
If you need to make modifications, the respective files should be changed within the repository’s top-level <code class="language-plaintext highlighter-rouge">src</code> directory.
Running <code class="language-plaintext highlighter-rouge">gulp LKG</code> will then appropriately update the files in this directory.</p>
  ...
  <script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      const currentPath = "vscode-extension/node_modules/typescript/lib/README.md";
