...
<script>
    ...
    <main class="content">
      <p><a href="https://github.com/zxing/zxing"><img align="right" src="https://raw.github.com/wiki/zxing/zxing/zxing-logo.png" /></a></p>

<h1 id="zxing">ZXing</h1>

<h2 id="project-in-maintenance-mode-only">Project in Maintenance Mode Only</h2>

<p>The project is in maintenance mode, meaning, changes are driven by contributed patches.
...
There is otherwise no active development or roadmap for this project. It is “DIY”.</p>

<h3 id="runs-on-your-favorite-ecmascript-ecosystem">Runs on your favorite ECMAScript ecosystem</h3>

<blockquote>
  <p>If it doesn’t, we gonna make it.</p>
</blockquote>

<h2 id="what-is-zxing">What is ZXing?</h2>

<blockquote>
  <p><a href="https://github.com/zxing/zxing">ZXing</a> (“zebra crossing”) is an open-source, multi-format 1D/2D barcode image processing library implemented in Java, with ports to other languages.</p>
</blockquote>

<h2 id="supported-formats">Supported Formats</h2>

<blockquote>
  <p>See <a href="https://github.com/zxing-js/library/projects">Projects</a> and <a href="https://github.com/zxing-js/library/milestones">Milestones</a> for what is currently done and what’s planned next. 👀</p>
</blockquote>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td> </td>
      <td>RSS-Expanded (not production ready!)</td>
      <td> </td>
    </tr>
  </tbody>
</table>
...
<p><a href="https://npmjs.org/package/@zxing/ngx-scanner"><img src="https://img.shields.io/badge/maintained-help%20wanted-red" alt="Maintainer wanted" /></a>
<a href="https://greenkeeper.io/"><img src="https://badges.greenkeeper.io/zxing-js/library.svg" alt="Greenkeeper badge" /></a></p>

<p><a href="https://www.npmjs.com/package/@zxing/library"><img src="https://img.shields.io/npm/v/@zxing/library.svg?&amp;label=npm" alt="NPM version" /></a>
<a href="https://www.npmjs.com/package/@zxing/library"><img src="https://img.shields.io/npm/dm/localeval.svg" alt="npm" /></a>
<a href="https://github.com/zxing-js/library/graphs/contributors"><img src="https://img.shields.io/github/contributors/zxing-js/library.svg" alt="Contributors" /></a>
<a href="https://github.com/zxing-js/library/compare/master...develop"><img src="https://img.shields.io/github/commits-since/zxing-js/library/master.svg?label=commits%20to%20deploy" alt="Commits to deploy" /></a></p>

<p><a href="https://codeclimate.com/github/zxing-js/library/maintainability"><img src="https://api.codeclimate.com/v1/badges/2b9c6ae92412ee8e15a9/maintainability" alt="Maintainability" /></a>
<a href="https://codeclimate.com/github/zxing-js/library/test_coverage"><img src="https://api.codeclimate.com/v1/badges/2b9c6ae92412ee8e15a9/test_coverage" alt="Test Coverage" /></a></p>

<h3 id="attention">Attention</h3>

<blockquote>
  <p>NOTE: While we do not have the time to actively maintain zxing-js anymore, we are open to new maintainers taking the lead.</p>
</blockquote>

<h2 id="demo">Demo</h2>

<p>See <a href="https://zxing-js.github.io/library/">Live Preview</a> in browser.</p>

<p><strong>Note:</strong> All the examples are using ES6, be sure is supported in your browser or modify as needed, Chrome recommended.</p>

<h2 id="installation">Installation</h2>

<p><code class="language-plaintext highlighter-rouge">npm i @zxing/library --save</code></p>

<p>or</p>

<p><code class="language-plaintext highlighter-rouge">yarn add @zxing/library</code></p>

<h2 id="limitations">Limitations</h2>

<p>On iOS-Devices <strong>with iOS &lt; 14.3</strong> camera access works only in native Safari and not in other Browsers (Chrome,…) or Apps that use an UIWebView or WKWebView. This is not a restriction of this library but of the limited WebRTC support by Apple. The behavior might change in iOS 11.3 (Apr 2018?, not tested) as stated <a href="https://developer.apple.com/library/content/releasenotes/General/WhatsNewInSafari/Articles/Safari_11_1.html#//apple_ref/doc/uid/TP40014305-CH14-SW1">here</a></p>

<blockquote>
  <p>iOS 14.3 (released in december 2020) now supports WebRTC in 3rd party browsers as well 🎉</p>
</blockquote>

<h3 id="browser-support">Browser Support</h3>

<p>The browser layer is using the <a href="https://developer.mozilla.org/en-US/docs/Web/API/MediaDevices">MediaDevices</a> web API which is not supported by older browsers.</p>

<p><em>You can use external polyfills like <a href="https://github.com/webrtc/adapter">WebRTC adapter</a> to increase browser compatibility.</em></p>

<p>Also, note that the library is using the <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray"><code class="language-plaintext highlighter-rouge">TypedArray</code></a> (<code class="language-plaintext highlighter-rouge">Int32Array</code>, <code class="language-plaintext highlighter-rouge">Uint8ClampedArray</code>, etc.) which are not available in older browsers (e.g. Android 4 default browser).</p>

<p><em>You can use <a href="https://github.com/zloirock/core-js">core-js</a> to add support to these browsers.</em></p>

<p>In the PDF 417 decoder recent addition, the library now makes use of the new <code class="language-plaintext highlighter-rouge">BigInt</code> type, which <a href="https://caniuse.com/#feat=bigint">is not supported by all browsers</a> as well. There’s no way to polyfill that and ponyfill libraries are <strong>way to big</strong>, but even if PDF 417 decoding relies on <code class="language-plaintext highlighter-rouge">BigInt</code> the rest of the library shall work ok in browsers that doesn’t support it.</p>

<p><em>There’s no polyfills for <code class="language-plaintext highlighter-rouge">BigInt</code> in the way it’s coded in here.</em></p>

<h2 id="usage">Usage</h2>

<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="c1">// use with commonJS</span>
<span class="kd">const</span> <span class="p">{</span> <span class="nx">MultiFormatReader</span><span class="p">,</span> <span class="nx">BarcodeFormat</span> <span class="p">}</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">@zxing/library</span><span class="dl">'</span><span class="p">);</span>
<span class="c1">// or with ES6 modules</span>
<span class="k">import</span> <span class="p">{</span> <span class="nx">MultiFormatReader</span><span class="p">,</span> <span class="nx">BarcodeFormat</span> <span class="p">}</span> <span class="k">from</span> <span class="dl">'</span><span class="s1">@zxing/library</span><span class="dl">'</span><span class="p">;</span>

<span class="kd">const</span> <span class="nx">hints</span> <span class="o">=</span> <span class="k">new</span> <span class="nb">Map</span><span class="p">();</span>
<span class="kd">const</span> <span class="nx">formats</span> <span class="o">=</span> <span class="p">[</span><span class="nx">BarcodeFormat</span><span class="p">.</span><span class="nx">QR_CODE</span><span class="p">,</span> <span class="nx">BarcodeFormat</span><span class="p">.</span><span class="nx">DATA_MATRIX</span><span class="cm">/*, ...*/</span><span class="p">];</span>

<span class="nx">hints</span><span class="p">.</span><span class="kd">set</span><span class="p">(</span><span class="nx">DecodeHintType</span><span class="p">.</span><span class="nx">POSSIBLE_FORMATS</span><span class="p">,</span> <span class="nx">formats</span><span class="p">);</span>

<span class="kd">const</span> <span class="nx">reader</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">MultiFormatReader</span><span class="p">();</span>

<span class="kd">const</span> <span class="nx">luminanceSource</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">RGBLuminanceSource</span><span class="p">(</span><span class="nx">imgByteArray</span><span class="p">,</span> <span class="nx">imgWidth</span><span class="p">,</span> <span class="nx">imgHeight</span><span class="p">);</span>
<span class="kd">const</span> <span class="nx">binaryBitmap</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">BinaryBitmap</span><span class="p">(</span><span class="k">new</span> <span class="nx">HybridBinarizer</span><span class="p">(</span><span class="nx">luminanceSource</span><span class="p">));</span>

<span class="nx">reader</span><span class="p">.</span><span class="nx">decode</span><span class="p">(</span><span class="nx">binaryBitmap</span><span class="p">,</span> <span class="nx">hints</span><span class="p">);</span>
</code></pre></div></div>

<h2 id="contributing">Contributing</h2>

<p>See <a href="https://github.com/zxing-js/library/blob/master/CONTRIBUTING.md">Contributing Guide</a> for information regarding porting approach and reasoning behind some of the approaches taken.</p>

<h2 id="contributors">Contributors</h2>

<p>Special thanks to all the contributors who have contributed for this project. We heartly thankful to you all.</p>

<p><a href="https://sourcerer.io/fame/odahcam/zxing-js/library/links/0"><img src="https://sourcerer.io/fame/odahcam/zxing-js/library/images/0" alt="" /></a><a href="https://sourcerer.io/fame/odahcam/zxing-js/library/links/1"><img src="https://sourcerer.io/fame/odahcam/zxing-js/library/images/1" alt="" /></a><a href="https://sourcerer.io/fame/odahcam/zxing-js/library/links/2"><img src="https://sourcerer.io/fame/odahcam/zxing-js/library/images/2" alt="" /></a><a href="https://sourcerer.io/fame/odahcam/zxing-js/library/links/3"><img src="https://sourcerer.io/fame/odahcam/zxing-js/library/images/3" alt="" /></a><a href="https://sourcerer.io/fame/odahcam/zxing-js/library/links/4"><img src="https://sourcerer.io/fame/odahcam/zxing-js/library/images/4" alt="" /></a><a href="https://sourcerer.io/fame/odahcam/zxing-js/library/links/5"><img src="https://sourcerer.io/fame/odahcam/zxing-js/library/images/5" alt="" /></a><a href="https://sourcerer.io/fame/odahcam/zxing-js/library/links/6"><img src="https://sourcerer.io/fame/odahcam/zxing-js/library/images/6" alt="" /></a><a href="https://sourcerer.io/fame/odahcam/zxing-js/library/links/7"><img src="https://sourcerer.io/fame/odahcam/zxing-js/library/images/7" alt="" /></a></p>

<p>And a special thanks to <a href="https://github.com/aleris">@aleris</a> who created the project itself and made available the initial QR code port.</p>

<hr />

<p><a href="http://lunagao.github.io/BlessYourCodeTag/"><img src="https://cdn.rawgit.com/LunaGao/BlessYourCodeTag/master/tags/alpaca.svg" alt="Bless" /></a></p>
  ...
  <script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      const currentPath = "DTRANSFER/projectsnew/javacode/src/main/java/swap/j/node_modules/@zxing/library/README.md";
