...
<p>This is a fork of https://github.com/inexorabletash/text-encoding, which
has been marked as deprecated in the npm registry.</p>

<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>npm info text-encoding
...
<p>This fork is published as <code class="language-plaintext highlighter-rouge">@zxing/text-encoding</code> and will be available as long
as it is in use by <code class="language-plaintext highlighter-rouge">@zxing</code> packages.</p>
...
<p>There are a few ways you can get and use the <code class="language-plaintext highlighter-rouge">@zxing/text-encoding</code> library.</p>

<h3 id="html-page-usage">HTML Page Usage</h3>

<p>Clone the repo and include the files directly:</p>

<div class="language-html highlighter-rouge"><div class="highlight"><pre class="highlight"><code>  <span class="c">&lt;!-- Required for non-UTF encodings --&gt;</span>
  <span class="nt">&lt;script </span><span class="na">src=</span><span class="s">"encoding-indexes.js"</span><span class="nt">&gt;&lt;/script&gt;</span>
  <span class="nt">&lt;script </span><span class="na">src=</span><span class="s">"encoding.js"</span><span class="nt">&gt;&lt;/script&gt;</span>
</code></pre></div></div>
...
<p>The package is published to <strong>npm</strong> as <code class="language-plaintext highlighter-rouge">@zxing/text-encoding</code>.
Use through these is not really supported, since they aren’t used by
the developer of the library. Using <code class="language-plaintext highlighter-rouge">require()</code> in interesting ways
probably breaks. Patches welcome, as long as they don’t break the
basic use of the files via <code class="language-plaintext highlighter-rouge">&lt;script&gt;</code>.</p>

<h3 id="api-overview">API Overview</h3>

<p>Basic Usage</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code>  <span class="kd">var</span> <span class="nx">uint8array</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">TextEncoder</span><span class="p">().</span><span class="nx">encode</span><span class="p">(</span><span class="nx">string</span><span class="p">);</span>
  <span class="kd">var</span> <span class="nx">string</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">TextDecoder</span><span class="p">(</span><span class="nx">encoding</span><span class="p">).</span><span class="nx">decode</span><span class="p">(</span><span class="nx">uint8array</span><span class="p">);</span>
</code></pre></div></div>

<p>Streaming Decode</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code>  <span class="kd">var</span> <span class="nx">string</span> <span class="o">=</span> <span class="dl">""</span><span class="p">,</span> <span class="nx">decoder</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">TextDecoder</span><span class="p">(</span><span class="nx">encoding</span><span class="p">),</span> <span class="nx">buffer</span><span class="p">;</span>
  <span class="k">while</span> <span class="p">(</span><span class="nx">buffer</span> <span class="o">=</span> <span class="nx">next_chunk</span><span class="p">())</span> <span class="p">{</span>
    <span class="nx">string</span> <span class="o">+=</span> <span class="nx">decoder</span><span class="p">.</span><span class="nx">decode</span><span class="p">(</span><span class="nx">buffer</span><span class="p">,</span> <span class="p">{</span><span class="na">stream</span><span class="p">:</span><span class="kc">true</span><span class="p">});</span>
  <span class="p">}</span>
  <span class="nx">string</span> <span class="o">+=</span> <span class="nx">decoder</span><span class="p">.</span><span class="nx">decode</span><span class="p">();</span> <span class="c1">// finish the stream</span>
</code></pre></div></div>
...
an additional <code class="language-plaintext highlighter-rouge">encoding-indexes.js</code> file to be included. It is rather
...
behavior by passing the <code class="language-plaintext highlighter-rouge">NONSTANDARD_allowLegacyEncoding</code> option to
TextEncoder and a label. For example:</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">uint8array</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">TextEncoder</span><span class="p">(</span>
  <span class="dl">'</span><span class="s1">windows-1252</span><span class="dl">'</span><span class="p">,</span> <span class="p">{</span> <span class="na">NONSTANDARD_allowLegacyEncoding</span><span class="p">:</span> <span class="kc">true</span> <span class="p">}).</span><span class="nx">encode</span><span class="p">(</span><span class="nx">text</span><span class="p">);</span>
</code></pre></div></div>
...
<span class="nb">window</span><span class="p">.</span><span class="nx">TextEncoder</span> <span class="o">=</span> <span class="nb">window</span><span class="p">.</span><span class="nx">TextDecoder</span> <span class="o">=</span> <span class="kc">null</span><span class="p">;</span>
<span class="nt">&lt;/script&gt;</span>
</code></pre></div></div>

<p>To support the legacy encodings (which may be stateful), the
TextEncoder <code class="language-plaintext highlighter-rouge">encode()</code> method accepts an optional dictionary and
<code class="language-plaintext highlighter-rouge">stream</code> option, e.g. <code class="language-plaintext highlighter-rouge">encoder.encode(string, {stream: true});</code> This
...
complete code points.</p>
  ...
  <script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      const currentPath = "DTRANSFER/projectsnew/javacode/src/main/java/swap/j/node_modules/@zxing/text-encoding/README.md";
