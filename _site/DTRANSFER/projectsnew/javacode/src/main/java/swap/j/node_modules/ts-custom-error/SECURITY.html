...
<p>Please <a href="https://github.com/adriengibrat/ts-custom-error/issues/new?labels=security">create an issue with the “security” label</a>.</p>
  ...
  <script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      const currentPath = "DTRANSFER/projectsnew/javacode/src/main/java/swap/j/node_modules/ts-custom-error/SECURITY.md";
